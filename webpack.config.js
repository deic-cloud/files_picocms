...
// Build deps live in the sibling app's node_modules (same versions as the other
// standalone builds; avoids a duplicate install). resolve.modules makes every
// bare require — including @nextcloud/* and nested deps — fall back there.
