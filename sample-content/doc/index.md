...
Title: Overview
Site: Sample Site
Description: What this is and where to start
Author: 
Access: public
Theme: documentation
date: 2001-01-01
...
[One paragraph: what this documents — a service, an instrument, a pipeline, a
dataset — who it is for, and what they can do with it.]
...
[Reference](%base_url%/reference) has the details, and the
[FAQ](%base_url%/faq) answers common questions.

**Status**: [production / beta / internal]
**Contact**: [%email%](mailto:%email%) <!-- prefilled with your email -->
